...
public class BaseClass {
	...
	public void setup(String os,String br) throws IOException
	{
		...
		if(p.getProperty("execution_environment").equalsIgnoreCase("remote"))
		{
			...
			case "default":System.out.println("OS not matched");return;
			}
			...
			{
				System.out.println("BR not matched");return;
			}
	...
	@AfterMethod(onlyForGroups = {"Master","Sanity","Regression"})
	...
	public String randomeAlphaNumeric()
	{
		...
		String randomNumerics=RandomStringUtils.randomAlphanumeric(5, 5);
		String randomAlphaNumeric=randomAlphabets+"@"+randomNumerics;
